...
def create_branches1(request):
    temp = [Round7_2017, Round7_2018, Round7_2019, Round_2015]
    reset(temp)
    ...
    for x in temp:
        ...
        x.objects.bulk_create(lists[name[13:]])
    return redirect('/soce/create_branch')
...
def createCollegeCategory(request):
    ...
    for row in data[name[8:]]['Id']:
        print(data[name[8:]]['Branch Code'][row-1])
        lists[name[8:]].append(x(
            id=int(data[name[8:]]['Id'][row-1]),
            institute_code=Institutes.objects.get(
                code=str(data[name[8:]]['Institute Code'][row-1])),
...
viewset_list = [
                BranchesViewSet, InstitutesViewSet, Round1_2016ViewSet, Round1_2017ViewSet, Round1_2018ViewSet,
                Round1_2019ViewSet, Round1_2020ViewSet, Round2_2020ViewSet,Round3_2020ViewSet,
                Round4_2020ViewSet, Round5_2020ViewSet, Round6_2016ViewSet, Round6_2020ViewSet, 
                Round7_2017ViewSet, Round7_2018ViewSet, Round7_2019ViewSet, Round_2015ViewSet,
                Provisional_2018ViewSet, Provisional_2019ViewSet, Provisional_2020ViewSet,
                CSAB_2020_1ViewSet, CSAB_2020_2ViewSet, Seat_2019ViewSet, Seat_2020ViewSet,
                CSAB_Seat_2020ViewSet, Round2_2016ViewSet, Round3_2016ViewSet, Round4_2016ViewSet,
                Round5_2016ViewSet, Round2_2017ViewSet, Round2_2018ViewSet, Round2_2019ViewSet, 
                Round3_2017ViewSet, Round3_2018ViewSet, Round3_2019ViewSet, Round4_2017ViewSet,
                Round4_2018ViewSet, Round4_2019ViewSet, Round5_2017ViewSet, Round5_2018ViewSet,
                Round5_2019ViewSet, Round6_2017ViewSet, Round6_2018ViewSet, Round6_2019ViewSet, 
                UpdatesViewSet, College_BranchViewSet, Seat_2021ViewSet, Seat_2021IViewSet, 
                College_CategoryViewSet, Round1_2021ViewSet, Round2_2021ViewSet, Round3_2021ViewSet, 
                Round4_2021ViewSet, Round5_2021ViewSet, Round6_2021ViewSet
                ]



def test(request):
    path = "database/CSV/Rounds"
     
    print(len([name for name in os.listdir(path) if not (os.path.splitext(name)[1] == '')]))
