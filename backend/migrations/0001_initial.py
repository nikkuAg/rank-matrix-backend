# Generated by Django 3.2.7 on 2022-12-19 07:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_updated', models.BooleanField(default=False)),
                ('college_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.college_type')),
            ],
        ),
        migrations.CreateModel(
            name='Seat_Pool',
        ...
        migrations.AddField(
            model_name='branches',
            name='currenlty_present',
            field=models.ManyToManyField(blank=True, related_name='Currently_Present', to='backend.College_Type'),
        ),
        migrations.AddField(
            model_name='branches',
            name='previously_present',
            field=models.ManyToManyField(blank=True, related_name='Previously_Present', to='backend.College_Type'),
        ),
    ]
