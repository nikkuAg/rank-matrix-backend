...
#Serializer for all models of year 2015
...
#Serializer for all models of year 2016
...
#Serializer for all models of year 2017
...
#Serializer for all models of year 2018
...
#Serializer for all models of year 2019
...
#Serializer for all models of year 2020
...
#Serializer for all models of year 2021
class Round1_2021Serializer(serializers.ModelSerializer):
    class Meta:
        model = Round1_2021
        fields = '__all__'

class Round2_2021Serializer(serializers.ModelSerializer):
    class Meta:
        model = Round2_2021
        fields = '__all__'

class Round3_2021Serializer(serializers.ModelSerializer):
    class Meta:
        model = Round3_2021
        fields = '__all__'

class Round4_2021Serializer(serializers.ModelSerializer):
    class Meta:
        model = Round4_2021
        fields = '__all__'

class Round5_2021Serializer(serializers.ModelSerializer):
    class Meta:
        model = Round5_2021
        fields = '__all__'

class Round6_2021Serializer(serializers.ModelSerializer):
    class Meta:
        model = Round6_2021
        fields = '__all__'
