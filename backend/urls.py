...
from .views import create2, create3, create4, create419, create5, create517, create518, create519, create6, create617, create618, create619, create7, create8, create_tables, createCollegeBranch, reset
