...
SEAT_MATRIX_SEARCH = ['quota__quota', 'category__category', 'seat_pool__seat_pool', 'seats', 'institute_code__name',
...
OPENING_CLOSING_SEARCH = ['quota__quota', 'category__category', 'seat_pool__seat_pool', 'opening_rank', 'closing_rank', 'institute_code__name',
        'institute_code__display_code','institute_code__city', 'institute_code__state', 'institute_code__college_type__type',
