...
from rank_matrix_stage.views.category import CategoryViewset
from rank_matrix_stage.views.college import CollegeTypeViewset, InstituteMinimalViewset, InstitutesViewset
from rank_matrix_stage.views.opening_closing_rank import RankViewsets, get_rounds
from rank_matrix_stage.views.perdictions.all_college_all_branch import all_college_all_branch
from rank_matrix_stage.views.perdictions.all_college_one_branch import BranchSearchViewset, all_college_one_branch
from rank_matrix_stage.views.perdictions.one_college_all_branch import one_college_all_branch
from rank_matrix_stage.views.perdictions.one_college_one_branch import  BranchInstituteSearchViewset, one_college_one_branch
from rank_matrix_stage.views.quota import instituteQuota
from rank_matrix_stage.views.recent_update import UpdateViewSet
from rank_matrix_stage.views.seat_matrix import SeatmatrixViewset
from rank_matrix_stage.views.seat_pool import SeatPoolViewset
from rank_matrix_stage.views.test_your_choice import test_your_choice
from rank_matrix_stage.views.year import get_year_list
